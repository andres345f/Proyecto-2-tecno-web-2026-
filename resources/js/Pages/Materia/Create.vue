...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: 'Crear', href: route('materias.create') },
];
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="flex h-full flex-1 flex-col gap-6 p-6 max-w-2xl">
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-3xl font-extrabold tracking-tight text-foreground">Crear Materia</h1>
                    <p class="text-sm text-muted-foreground mt-1">Registra una nueva asignatura en el plan de estudios.</p>
                </div>
